	...
	<body>
		...
		<div class="container-fluid bg-green-gluck fixed-top d-md-none">
			...
			<div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
				<div href="<?php echo base_url('nosotros'); ?>" class="pt-1 pb-1 ancla b-activo">Nosotros</div>
		...
		<div class="container pt-5 h-header box-shadow-down">
			<div class="row no-gutters w-100 h-100">
				<div class="col-md-7">
					<h5 class="text-uppercase font-climousinesb font-weight-bold">¿Quiénes somos?</h5>
					<p class="description">
						Una institución que organiza, realiza banquetes para cualquier tipo de evento. Congresos tanto
						nacionales
						como internacionales. Tenemos privilegio de operar en puntos relevantes de la Ciudad de México.
						Igual
						organizamos eventos privados en Hoteles, Recintos Históricos y las mismas instalaciones del
						Cliente.
					</p>
					<h5 class="text-uppercase font-climousinesb font-weight-bold">¿Cuál es nuestra misión?</h5>
					<p class="description">
						Integrar soluciones de alto contenido de valor agregado deacuerdo a sus necesidades, logrando
						así, nos
						considere su proveedor de confianza.
					</p>
					<h5 class="text-uppercase font-climousinesb font-weight-bold">¿Cómo trabajamos?</h5>
					<p class="description">
						Contamos con personal perfectamente capacitado para realizar de sus eventos un éxito tanto en
						las instalaciones
						del cliente como en el lugar que nos lo señalen.
					</p>
					<h5 class="text-uppercase font-climousinesb font-weight-bold">Nuestro trabajo</h5>
					<p class="description">
						Nuestra amplia experiencia nos coloca en diferentes ámbitos de craeción y organización de
						eventos.
						Queremos dar la mejor experiencia y dar todos los elementos necesarios desde los mas pequeños
						como un
						arreglo floral hasta la organización de todo tu evento
					</p>
				</div>
				<div class="col-md-1 text-center"></div>
				<div class="col-md-4 text-center">
					<h6 class="text-uppercase font-climousinesb font-weight-bold">Síguenos en nuestras redes</h6>
					<a href="">
						<img width="70" src="<?php echo base_url('assets/img/Iconos-08.svg'); ?>" alt="facebook">
					</a>
					<a href="">
						<img width="70" src="<?php echo base_url('assets/img/Iconos-09.svg'); ?>" alt="instagram">
					</a>
					<a href="">
						<img width="70" src="<?php echo base_url('assets/img/Iconos-10.svg'); ?>" alt="photos">
					</a>
				</div>
			</div>
		</div>
			...
			<div class="row justify-content-center pt-4">
				<div class="col-md-3">
					<div class="p-3 p-relative text-center bg-purple-gluck">
						<a href="<?php echo base_url('eventos'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white">
				...
				<div class="col-md-3">
					<div class="p-3 p-relative text-center bg-green-gluck">
						<a href="<?php echo base_url('banquetes'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white">
				...
				<div class="col-md-3">
					<div class="p-3 p-relative text-center bg-orange-gluck">
						<a href="<?php echo base_url('congresos'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white">

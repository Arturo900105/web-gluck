    ...
    <div class="container">
        <div id="original-nav" class="row align-items-center pt-2 pb-0 mb-0">
            ...
            <div class="row col-md-7 ml-1">
                ...
                <a href="<?php echo base_url('convenciones'); ?>" class="col-md-4 pt-2 pb-2 m-button ancla b-activo">
...
<div class="container-fluid bg-green-gluck fixed-top d-md-none">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div href="<?php echo base_url('convenciones'); ?>" class="pt-1 pb-1 ancla b-activo">Convenciones</div>
    </div>
</div>
